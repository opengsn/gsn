...
../../relaydc/add-instance ../../relaydc/docker-compose.yml  > build/relaydc2/docker-compose.yml
...
TIMEOUT=30 waitForUrl http://$MYIP:8080/gsn1/getaddr RelayHubAddress.*0x || fatal "no relayer gsn1"
waitForUrl http://$MYIP:8080/gsn2/getaddr RelayHubAddress.*0x || fatal "no relayer gsn2"
