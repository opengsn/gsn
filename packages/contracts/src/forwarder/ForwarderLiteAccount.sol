...
/**
 * @title The Forwarder Lite Account Implementation.
 * @notice This implementation of an EIP-7702 delegated EOAs uses ERC-712 signatures and stored nonces for verification.
 * @notice It is intended to be used with a simplified meta-transactions relaying system.
 * @notice It is not a full-fledged ERC-4337 style Account Abstraction account.
 */
contract ForwarderLiteAccount is ERC165 {
    using ECDSA for bytes32;

    address private constant DRY_RUN_ADDRESS = 0x0000000000000000000000000000000000000000;

    string public constant GENERIC_PARAMS = "ForwardRequest(address from,address to,uint256 value,uint256 gas,uint256 nonce,bytes data,uint256 validAfterTime,uint256 validUntilTime)";
    ...
    constructor() {
        string memory requestType = string(abi.encodePacked("(", GENERIC_PARAMS, ")"));
